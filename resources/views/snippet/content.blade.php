        ...
        <div class="container-fluid py-2">
            ...
            <div class="row">
                ...
                <div class="brand-item col-sm-4 col-md-2 col-xl-1">
                    <a href="{{ route('api.snippet.search', ['id' => $id,'brand' => $brand['brand'], 'theme' => $theme, 'color' => $color, 'btextcolor' => $btextcolor, 'background' => $background, 'px' => $px, 'py' => $py]) }}" class="brand-link">
