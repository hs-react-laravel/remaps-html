...
<section id="basic-input">
  <form id="form-create" action="{{ route($route_prefix.'notifications.store') }}" method="post">
    @csrf
    <div class="row">
      <div class="col-md-8">
        <div class="card">
            ...
            <div class="row mb-1">
              ...
              <div class="col-12 mt-1">
                <div class="form-check form-check-inline">
                  ...
                  <input class="form-check-input" type="checkbox" id="to_all" name="to_all" value="1" checked/>
                  <label class="form-check-label" for="to_all">Send Notification to all customers</label>
                </div>
              </div>
              <div class="col-12">
                <label class="form-label" for="to">To</label>
                <select class="select2 form-select" id="to" name="to[]" multiple disabled>
                  @foreach ($users as $u)
