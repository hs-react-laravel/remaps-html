            ...
            <div class="top-left">
              <ul class="list-style-one">
                <li>
                  ...
                  <a
                    href="/cdn-cgi/l/email-protection#147a7171707c71786454777b7964757a6d3a777b79"
                    ><span
                      class="__cf_email__"
                      data-cfemail="cba5aeaeafa3aea7bb8ba8a4a6bbaaa5b2e5a8a4a6"
            ...
            <ul class="contact-list-one">
              ...
              <li>
                <div class="contact-info-box">
                  ...
                  <a
                    href="/cdn-cgi/l/email-protection#b2dad7dec2f2d1dddfc2d3dccb9cd1dddf"
                    ><span
                      class="__cf_email__"
                      data-cfemail="5a323f362a1a3935372a3b342374393537"
                      >[email&#160;protected]</span
                    ></a
                  >
                </div>
          ...
          <div class="mixitup-gallery">
            <div class="filters clearfix">
              <ul class="filter-tabs filter-btns clearfix">
                ...
                <li class="filter" data-role="button" data-filter=".dairy">
                  Cyber
                </li>
                <li class="filter" data-role="button" data-filter=".pantry">
                  Digital
                </li>
                <li class="filter" data-role="button" data-filter=".meat">
                  Software
                </li>
                <li class="filter" data-role="button" data-filter=".fruit">
                  Technology
                </li>
                <li class="filter" data-role="button" data-filter=".vagetables">
                  Development
                </li>
              </ul>
            </div>
            <div class="filter-list row">
              ...
              <div
                class="product-block all mix dairy meat vagetables col-lg-3 col-md-6 col-sm-12"
              >
                <div class="inner-box">
                  <div class="image">
                    <a href="shop-product-details.html"
              ...
              <div
                class="product-block all mix pantry meat fruit col-lg-3 col-md-6 col-sm-12"
              >
                <div class="inner-box">
                  <div class="image">
                    <a href="shop-product-details.html"
              ...
              <div
                class="product-block all mix dairy pantry col-lg-3 col-md-6 col-sm-12"
              >
                <div class="inner-box">
                  <div class="image">
                    <a href="shop-product-details.html"
              ...
              <div
                class="product-block all mix fruit vagetables col-lg-3 col-md-6 col-sm-12"
              >
                <div class="inner-box">
                  <div class="image">
                    <a href="shop-product-details.html"
            ...
            <div class="row">
              ...
              <div class="contact-info-block col-lg-4 col-md-6">
                <div class="inner">
                  ...
                  <div class="text">
                    <a
                      href="/cdn-cgi/l/email-protection#513f34343539343d2111323e3c21303f287f323e3c"
                      ><span
                        class="__cf_email__"
                        data-cfemail="cba5aeaeafa3aea7bb8ba8a4a6bbaaa5b2e5a8a4a6"
                        >[email&#160;protected]</span
