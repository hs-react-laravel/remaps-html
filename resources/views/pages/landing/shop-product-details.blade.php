...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Desix | Digital agency HTML Template</title>
  ...
  <body>
            ...
            <div class="top-left">
              <ul class="list-style-one">
                <li>
                  ...
                  <a
                    href="/cdn-cgi/l/email-protection#137d7676777b767f6353707c7e63727d6a3d707c7e"
                    ><span
                      class="__cf_email__"
                      data-cfemail="ec828989888489809cac8f83819c8d8295c28f8381"
            ...
            <ul class="contact-list-one">
              ...
              <li>
                <div class="contact-info-box">
                  ...
                  <a
                    href="/cdn-cgi/l/email-protection#630b060f1323000c0e13020d1a4d000c0e"
                    ><span
                      class="__cf_email__"
                      data-cfemail="6b030e071b2b0804061b0a051245080406"
                      >[email&#160;protected]</span
                    ></a
                  >
                </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-xl-6 product-info">
              ...
              <div class="product-details__reveiw">
                ...
                <i class="fa fa-star"></i> <i class="fa fa-star"></i>
                <i class="fa fa-star"></i> <span>2 Customer Reviews</span>
              </div>
              ...
              <div class="product-details__buttons">
                <div class="product-details__buttons-1">
                  <a href="shop-cart.html" class="theme-btn btn-style-one"
                    ><span class="btn-title">Add to Cart</span></a
                  >
                </div>
                <div class="product-details__buttons-2">
                  <a
                    ...
                    ><span class="btn-title">Add to Wishlist</span></a
                  >
                </div>
              </div>
              <div class="product-details__social">
                <div class="title mt-10"><h3>Share with friends</h3></div>
                <div class="ml-30 blog-details__social-list">
                  <a href="shop-product-details.html"
                  ...
                  <div class="text">
                    ...
                    <div class="product-description__list">
                      <ul class="list-unstyled">
                        <li>
                          <p>
                            <span class="fa fa-arrow-right"></span> Nam at elit
                            nec neque suscipit gravida.
                          </p>
                        </li>
                        <li>
                          <p>
                            <span class="fa fa-arrow-right"></span> Aenean
                            egestas orci eu maximus tincidunt.
                          </p>
                        </li>
                        <li>
                          <p>
                            <span class="fa fa-arrow-right"></span> Curabitur
                            vel turpis id tellus cursus laoreet.
                          </p>
                        </li>
                      </ul>
                    </div>
                    <p class="product-description__tex2">
            ...
            <div class="col">
              <div class="mixitup-gallery">
                <div class="filter-list row">
                  ...
                  <div
                    class="product-block all mix dairy meat fruit col-lg-3 col-md-6 col-sm-12"
                  >
                    <div class="inner-box">
                      <div class="image">
                        <a href="shop-product-details.html"
                      ...
                      <div class="content">
                        <h4><a href="shop-product-details.html">Lagage</a></h4>
                        <span class="price">$32.00</span>
                        <span class="rating"
                          ><i class="fa fa-star"></i><i class="fa fa-star"></i
                          ><i class="fa fa-star"></i><i class="fa fa-star"></i
                  ...
                  <div
                    class="product-block all mix pantry fruit vagetables col-lg-3 col-md-6 col-sm-12"
                  >
                    <div class="inner-box">
                      <div class="image">
                        <a href="shop-product-details.html"
                      ...
                      <div class="content">
                        <h4><a href="shop-product-details.html">Watch</a></h4>
                        <span class="price">$32.00</span>
                        <span class="rating"
                          ><i class="fa fa-star"></i><i class="fa fa-star"></i
                          ><i class="fa fa-star"></i><i class="fa fa-star"></i
                  ...
                  >
                    <div class="inner-box">
                      ...
                      <div class="content">
                        <h4><a href="shop-product-details.html">SD Card</a></h4>
                        <span class="price">$32.00</span>
                        <span class="rating"
                          ><i class="fa fa-star"></i><i class="fa fa-star"></i
                          ><i class="fa fa-star"></i><i class="fa fa-star"></i
            ...
            <div class="row">
              ...
              <div class="contact-info-block col-lg-4 col-md-6">
                <div class="inner">
                  ...
                  <div class="text">
                    <a
                      href="/cdn-cgi/l/email-protection#84eae1e1e0ece1e8f4c4e7ebe9f4e5eafdaae7ebe9"
                      ><span
                        class="__cf_email__"
                        data-cfemail="95fbf0f0f1fdf0f9e5d5f6faf8e5f4fbecbbf6faf8"
                        >[email&#160;protected]</span
                      ></a
                    >
                  </div>
    ...
    <script src="{{ asset('landing/js/bxslider.js') }}"></script>
