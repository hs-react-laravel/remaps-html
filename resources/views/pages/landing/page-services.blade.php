            ...
            <div class="top-left">
              <ul class="list-style-one">
                <li>
                  ...
                  <a
                    href="/cdn-cgi/l/email-protection#49272c2c2d212c2539092a262439282730672a2624"
                    ><span
                      class="__cf_email__"
                      data-cfemail="315f54545559545d4171525e5c41505f481f525e5c"
            ...
            <ul class="contact-list-one">
              ...
              <li>
                <div class="contact-info-box">
                  ...
                  <a
                    href="/cdn-cgi/l/email-protection#d5bdb0b9a595b6bab8a5b4bbacfbb6bab8"
                    ><span
                      class="__cf_email__"
                      data-cfemail="d7bfb2bba797b4b8baa7b6b9aef9b4b8ba"
                      >[email&#160;protected]</span
                    ></a
                  >
                </div>
          ...
          <div class="row">
            ...
            >
              <div class="inner-box">
                ...
                <div class="content-box">
                  <i class="icon flaticon-megaphone"></i>
                  <h5 class="title">App <br />development</h5>
                </div>
                <div class="hover-content">
                  <i class="icon flaticon-design"></i>
                  <h5 class="title">
            ...
            >
              <div class="inner-box">
                ...
                <div class="content-box">
                  <i class="icon flaticon-design"></i>
                  <h5 class="title">UI/UX <br />designing</h5>
                </div>
                <div class="hover-content">
                  <i class="icon flaticon-megaphone"></i>
                  <h5 class="title">
            ...
            >
              <div class="inner-box">
                ...
                <div class="content-box">
                  <i class="icon flaticon-web-development"></i>
                  <h5 class="title">SEO <br />optimization</h5>
                </div>
                <div class="hover-content">
                  <i class="icon flaticon-visitor"></i>
                  <h5 class="title">
            ...
            <div class="row">
              ...
              <div class="contact-info-block col-lg-4 col-md-6">
                <div class="inner">
                  ...
                  <div class="text">
                    <a
                      href="/cdn-cgi/l/email-protection#e8868d8d8c808d8498a88b878598898691c68b8785"
                      ><span
                        class="__cf_email__"
                        data-cfemail="e48a8181808c818894a4878b8994858a9dca878b89"
                        >[email&#160;protected]</span
                      ></a
                    >
                  </div>
