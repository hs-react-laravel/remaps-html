            ...
            <div class="top-left">
              <ul class="list-style-one">
                <li>
                  ...
                  <a
                    href="/cdn-cgi/l/email-protection#107e75757478757c6050737f7d60717e693e737f7d"
                    ><span
                      class="__cf_email__"
                      data-cfemail="355b5050515d50594575565a5845545b4c1b565a58"
            ...
            <ul class="contact-list-one">
              ...
              <li>
                <div class="contact-info-box">
                  ...
                  <a
                    href="/cdn-cgi/l/email-protection#3c5459504c7c5f53514c5d5245125f5351"
                    ><span
                      class="__cf_email__"
                      data-cfemail="d3bbb6bfa393b0bcbea3b2bdaafdb0bcbe"
                      >[email&#160;protected]</span
                    ></a
                  >
                </div>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-4">
              <div class="pricing-block">
                <div class="inner-box">
                  <figure class="image">
                    <img src="images/resource/pricing-1.png" alt />
                  </figure>
                  <div class="price-box">
            ...
            <div class="col-xl-4 col-lg-4">
              <div class="pricing-block">
                <div class="inner-box">
                  <figure class="image">
                    <img src="images/resource/pricing-2.png" alt />
                  </figure>
                  <div class="price-box">
                    <h4 class="price"><sup>$</sup>69</h4>
                    <span class="validaty">/ Monthly</span>
                  </div>
                  <h4 class="title">Advance Plan</h4>
                  <ul class="features">
                    <li>24/7 system monitoring</li>
                    <li>Security management</li>
                    <li>Patch management</li>
            ...
            <div class="row">
              ...
              <div class="contact-info-block col-lg-4 col-md-6">
                <div class="inner">
                  ...
                  <div class="text">
                    <a
                      href="/cdn-cgi/l/email-protection#422c2727262a272e3202212d2f32232c3b6c212d2f"
                      ><span
                        class="__cf_email__"
                        data-cfemail="b9d7dcdcddd1dcd5c9f9dad6d4c9d8d7c097dad6d4"
                        >[email&#160;protected]</span
                      ></a
                    >
                  </div>
