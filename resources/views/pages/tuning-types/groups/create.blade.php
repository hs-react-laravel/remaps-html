...
<section id="basic-input">
  <form id="storeForm" action="{{ route('tuning-types.group.store') }}" method="post">
    @csrf
    <div class="row">
      <div class="col-md-12">
        <div class="card">
              ...
              <div class="col-xl-3 col-md-6 col-12 ms-2">
                @foreach ($types as $t)
                  <div class="credits-container credits-container-{{ $t->id }}" style="display: none">
                    <div>
                      <label class="form-label" for="credits">Tuning Type Credits</label>
                      <input type="number"
                        class="form-control"
                        id="credits_{{ $t->id }}"
                    ...
                    <div>
                      <label class="form-label" for="credits">{{ $to->label }}</label>
                      <input type="number"
                        class="form-control"
