...
data-asset-path="{{ asset('/')}}">
  ...
  <div class="app-content content {{ $configData['pageClass'] }} {{ 'theme-'.substr($configData['navbarColor'], 3) }}">
    ...
    <div class="content-area-wrapper {{ $configData['layoutWidth'] === 'boxed' ? 'container-xxl p-0' : '' }}" style="@if ($routeName == 'customer.shop.physical' || $routeName == 'customer.shop.digital') min-height: 1700px; @endif">
