<html lang="en" class="js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths"><head>
    ...
    {{-- <script src="https://remapdash.com/api/snippetjs?id=6&px=10&py=10"></script> --}}
    {{-- <script src="http://localhost:8080/api/snippetjs?id=1&px=10&py=10"></script> --}}
        ...
        <div class="container">
          ...
          @if (!empty($slider))
             ...
             <div class="">
                 ...
                 @if($slide['image'])
                   <div class="img-block">
                       <img class="main-slider-img" src="{{ Storage::disk('azure')->url($slide['image']) }}" alt="banner">
                   </div>
                 @endif
                    ...
                    @foreach($packages as $val)
					    <div class="@php echo $classDiv @endphp">
                            <div class="table long-table text-center">
                                ...
                                {!! $val['description'] !!}
                                <a href="/register-account?domain={{strpos($val['name'], 'own') !== false ? 'own' : 'regular'}}" class="btn btn-default-blue-tiny editContent">Register</a>
                            </div>
                        </div>
                    @endforeach
                 </div>
